...
module tr_lg( input clk, rst, output reg [2:0] light // {Red, Yellow, Green} );
// State encoding
...
module tr_lg_tb; reg clk,rst; wire [2:0] light;
...
<img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/13708a13-5d72-4eaf-8aeb-692070d4f94a" />
